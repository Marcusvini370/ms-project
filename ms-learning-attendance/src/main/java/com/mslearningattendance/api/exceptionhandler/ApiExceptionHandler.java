...
import com.mslearningattendance.core.validation.ValidationException;
import com.mslearningattendance.domain.exception.BusinessException;
import com.mslearningattendance.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("The resource %s, that you tried to access, is non-existent.", ex.getRequestURL());
